    ...
    return (
        ...
        <section id="WebServices">
            ...
            <div className="summaryBox">
                ...
                <ul>
                    <li>What businesses do you know of nowadays that don't have a website? A website will keep you up to date between competitors.</li>
                    <li>Increasing your audience by means of accessible technology, acts like digital word of mouth as your customers can quickly share a link.</li>
            ...
            <div className="processBox">
                ...
                <ol>
                    ...
                    <li><h3>Prototype</h3>
                        <p>In this stage you'll be given a PDF prototype of your website complete with all images, content, and styles you've provided.</p>
                        <p className="desc">The difference between wireframes and prototypes? Hover over for an example.</p>
                        <img id="wireProtoImg" src={wireEx} onMouseOver={mouseOver} onMouseOut={mouseOut}/></li>
            ...
            <div id="callToAct">
                ...
                <button>Contact Honeycomb!</button>
            </div>
